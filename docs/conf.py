# -*- coding: utf-8 -*-
#
# SeattleFluStudy documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'seattleflustudydoc'
...
latex_documents = [
    ('index',
     'seattleflustudy.tex',
     u'SeattleFluStudy Documentation',
     u"TheMikeMerrill", 'manual'),
]
